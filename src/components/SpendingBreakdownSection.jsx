...
/** Section for dashboard: spending by category (no back button, no year selector). */
  ...
  return (
    <section className="mt-8">
      ...
      <p className="text-slate-500 text-sm mb-6">
        Where your money went{selectedYear != null ? ` in ${selectedYear}` : ''}.
      </p>
      ...
      >
        <div className="px-5 py-4 border-b border-white/10">
          <h3 className="font-semibold text-white">Where you spent</h3>
      ...
      {selectedYear != null && monthlySpending.length > 0 && (
        ...
        >
          <div className="px-5 py-4 border-b border-white/10">
            <h3 className="font-semibold text-white">Spending by month</h3>
      ...
      {selectedYear == null && yearlyAverages.length > 0 && (
        ...
        >
          <div className="px-5 py-4 border-b border-white/10">
            <h3 className="font-semibold text-white">Average spending per year</h3>
            <p className="text-xs text-slate-500 mt-0.5">
